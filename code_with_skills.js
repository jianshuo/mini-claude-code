...
const history = [{
    role: "system",
    content:
        "You are a coding assistant. Use tools to read, list, and edit files — never guess file contents. " +
        "Always call a tool when the task involves the filesystem. Always output code into the filesystem.\n\n" +
        `${skills.size} skills are available. When the user invokes /skill-name, you will receive the skill ` +
        "instructions as a system message and must follow them exactly.",
}];
